  ...
  return (
    <footer className="bg-[#2f4a3d] text-white">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mb-10 rounded-[2rem] bg-[#fffdf8] p-7 text-[#1d1a16] shadow-xl sm:p-9 lg:flex lg:items-center lg:justify-between">
          <div>
            <p className="mb-2 text-sm font-black uppercase tracking-[0.25em] text-[#b86b3c]">Contact</p>
            <h2 className="max-w-2xl text-3xl font-black sm:text-4xl">Parlons de votre projet</h2>
          </div>
          <div className="mt-6 flex flex-col gap-3 sm:flex-row lg:mt-0">
            <a href="tel:0668008694" className="inline-flex justify-center rounded-full border border-[#1d1a16]/15 px-7 py-3.5 text-sm font-black uppercase tracking-wide text-[#1d1a16] transition hover:border-[#b86b3c] hover:text-[#b86b3c]">Appeler</a>
            <Link href="/contact" className="inline-flex justify-center rounded-full bg-[#b86b3c] px-7 py-3.5 text-sm font-black uppercase tracking-wide text-white transition hover:bg-[#9f5930]">Devis</Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm leading-7 text-white/65">Menuiserie et rénovation près de La Rochelle.</p>
          ...
          <div><h4 className="mb-4 text-sm font-black uppercase tracking-widest text-[#f4c8a8]">Services</h4><ul className="space-y-2 text-sm text-white/65">{services.map(([label, href]) => <li key={href}><Link href={href} className="transition-colors hover:text-white">{label}</Link></li>)}</ul></div>

          <div>
            <h4 className="mb-4 text-sm font-black uppercase tracking-widest text-[#f4c8a8]">Coordonnées</h4>
          ...
          <div><h4 className="mb-4 text-sm font-black uppercase tracking-widest text-[#f4c8a8]">Légal</h4><ul className="space-y-2 text-sm text-white/65">{legalLinks.map(([label, href]) => <li key={href}><Link href={href} className="transition-colors hover:text-white">{label}</Link></li>)}</ul></div>
        </div>

        <div className="mt-10 border-t border-white/10 pt-8 text-center text-xs leading-6 text-white/45">
